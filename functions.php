...
/*	wp_enqueue_script( 'sanctuary-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true ); */
	...
	wp_enqueue_script( 'open-sans', 'http://use.edgefonts.net/open-sans.js', false, false, false);
	wp_enqueue_script( 'open-sans-condensed', '//use.edgefonts.net/arvo;open-sans;open-sans-condensed.js', false, false, false);
